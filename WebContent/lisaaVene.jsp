...
<nav class="navbar navbar-expand-md navbar-dark sticky-top">
     ...
     <a class="navbar-brand" href="index.jsp">Veneohjelma</a>
...
<h3 class="container">Veneen lis‰‰minen</h3><br>
...
<form id="lomake" class="container">
	...
	<div class="form-group">
		<input type="button" id="tallenna" name="nappi" value="Lis‰‰ vene" onclick="lahetaTiedot()" class="btn btn-outline-light">
